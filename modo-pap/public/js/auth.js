// auth.js - simple front-end auth simulation
(function(){
  ...
  if(match){ localStorage.setItem('ns-session', JSON.stringify({email})); window.location.href = 'app.html'; }
  else alert('Usuário não encontrado. Registre-se ou use credenciais de teste.');
    });
  }
